...
Perhaps the most important remark I can give you is that the loss is computed in the loss_func function in __init__.py and functions therein. (This will eventually turn to a user-defined function passed through __main__).
